...
class NFTWallet:
    ...
    async def generate_new_nft(
        ...
        p2_inner_puzzle = await self.standard_wallet.get_puzzle(new=not reuse_puzhash)
    ...
    async def make_nft1_offer(
        ...
        p2_ph = await wallet_state_manager.main_wallet.get_puzzle_hash(new=not reuse_puzhash)
